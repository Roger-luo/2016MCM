...
plt.scatter([Data.Population[t] for t in years],[Data.WaterUseIndustry[t] for t in years],marker="^",s=100)
plt.show()
plt.close()
...
plt.ylabel("Industry Water Usage/ 100m m^3")
plt.scatter([Data.PCGDP[t] for t in years],[Data.WaterUseIndustry[t] for t in years],marker="^",s=100)
plt.show()
plt.close()
...
plt.ylabel("Electricity/ 100m kWh")
plt.scatter([Data.WaterUseIndustry[t] for t in years],[Data.Electricity[t] for t in years],marker="^",s=100)
plt.show()
plt.close()
...
plt.figure()
plt.xlabel("Domestic Water Usage/ 100m m^3")
plt.ylabel("Rural Engel/ Percentage")
...
plt.figure()
plt.xlabel("Domestic Water Usage/ 100m m^3")
plt.ylabel("UrbanEngel/ Percentage")
