...
To cover the internal dynamics of the water flow and the the relation between some regional statistical parameters, we introduce following model.
...
North China has experienced heavy demand for water, and groundwater is an important source for water supply in this area.The average rate of water resource use ranged from 31.0\% to 91.7\% for basins in the north compared to rates of 1.7 每 19.5\% in the south.\cite{MWR2007a}

\item Reduced in stream flow and degraded aquatic ecosystems.

The discharge from the river to the ocean dwindled from an annual average of 24 billion $m^3$ in the 1950 s to 1 billion $m^3$ in 2001.\cite{Xia2007}

\item Groundwater depletion.

It's recorded that groundwater depletion has increased in North China over the last two decades.Since the beginning of the 1980s, regions that over exploit groundwater have increased from 56 to 164 and the total area subject to groundwater overexploitation has increased from 87,000 $km^2$ to 180,000 $km^2$.\cite{MWR2007b}
...
\section{China's water scarcity: Further Investigation and Prediction}
  ...
  \begin{figure}[!h]
  \centering
  \subfigure[$P$]{\includegraphics[width = 0.22\textwidth]{picture/Population-Industry.png}}
  \subfigure[$\text{PCGDP}$]{\includegraphics[width = 0.22\textwidth]{picture/PCGDP-Industry.png}}
  \subfigure[$\text{ELP}$]{\includegraphics[width = 0.22\textwidth]{picture/Electricity-Industry.png}}
  \subfigure[$\text{ISP}$]{\includegraphics[width = 0.22\textwidth]{picture/SteelProduct-Industry.png}}
...
\section{Intervention plan designing and prediction}
  ...
  \begin{itemize}
    \item population control may cause population aging which may cause suppression to long-term economic development. And bad economic shape may lead to the lack of water conservancy facilities.
    \item water distribution intervention will be likely to impact water source's ecosystem, which is possible to cause future disasters.
  \end{itemize}
  Furthermore, the surrounding areas will suffer water scarcity or water stress by the result of:
  \begin{itemize}
    \item Exporting virtual water, such as iron and steel trading.
    \item Water conservancy facilities caused water scarcity for downstream regions, for instance, a dam on the upstream may cause lower water level in downstream.
  \end{itemize}
...
\begin{thebibliography}{99}
  ...
  \bibitem{research1} Water Scarcity. International Decade for Action \'Water for Life\' 2005每2015. un.org. Retrieved 20 October 2013.
  ...
  \bibitem{Review} China's water scarcity,Yong Jiang,Journal of Environmental Management Volume 90, Issue 11, August 2009, Pages 3185每3196
  ...
  \bibitem{MWR2007b}MWR (Ministry of Water Resources, P.R. China) The 11th Five-Year Plan of National Water Resources Development, Gazette of the Ministry of Water Resources of the P.R China, 2007 (2007), pp. 34每48
  ...
  \bibitem{Xia2007}J. Xia L. Zhang, C.M. Liu, J.J. Yu Towards better water security in North China Water Resource Management, 21 (2007), pp. 233每247
  \bibitem{MWR2007b} MWR (Ministry of Water Resources, P.R. China)The 11th Five-Year Plan of National Water Resources Development, Gazette of the Ministry of Water Resources of the P.R China, 2007 (2007), pp. 34每48
  ...
  \bibitem{SEPA} SEPA (State Environmental Protection Administration, P.R. China)China Environmental Bulletins 1990每2006 State Environmental Protection Administration, Beijing, China (1991每2007)
